...
public class LoanApplicationTopology {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(LoanApplicationTopology.class);
    ...
    @Autowired
    public LoanApplicationTopology(KafkaStreamsConfiguration streamsConfigs) {
    ...
    public Topology topology() {
        ...
        Aggregator<String, LoanApplication, LoanAppRollup> rollupAggregator = (k, v, agg)-> agg.update(v);
        ...
        processedLoanStream.selectKey((k, v) -> {
                ...
                .aggregate(LoanAppRollup::new, rollupAggregator,
        ...
        processedLoanStream.peek((k, v) -> LOG.info("Processed loan application {}", v))
          ...
          return builder.build(streamsConfigs.asProperties());
    }
}
